      ...
      <div className="doctor-profile-top">
        <div className="doctor-profile-info">
          ...
          <div className="doctor-profile-info-text">
            ...
            <div className="separator" />
            <div>
              <FaQuoteLeft /> You're day midst of brought. Winged together which
              forth itself in you air dominion good darkness seed upon be made
              upon i moved.
            </div>
          </div>
        </div>
        <div>
          <h3>Biography</h3>
          <p>
            Bearing called a fruit greater created hath fourth two. Also. Light
            day greater wherein made. Days, stars fruit she'd after male fowl
            lesser divided. Firmament one whales called of, firmament god you're
            waters years upon abundantly brought image, void above he, saw.
            Doesn't rule, god, unto greater and fish, spirit forth There. Deep
            face upon greater you, seasons one. Day spirit so dry he called.
          </p>
        </div>
